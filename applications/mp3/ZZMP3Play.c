 ...
 * Ajout : élévation de priorité à 12 pour réduire glitches sous charge.
 * 
  */
...
int main(int argc, char *argv[])
{
    ...
    /* Élever la priorité de la tâche à 10 pour minimiser les glitches */
    {
        struct Task *me = FindTask(NULL);
        if (me) {
            SetTaskPri(me, 12);
            Printf("Priorité tâche élevée à 12\n");
        }
    }
